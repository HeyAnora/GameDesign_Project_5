...
namespace UnfinityGames.U2DEX
{
	public static class AdvancedSnapping_UI
	{
		...
		private static void DrawGridOptions(int Width)
		{
			...
			//Draw our Small Grid Size Warning here, as our DrawGUI doesn't automatically handle rendering this error for
			//the preference menu. (By design, as we want to display it below the extra preference menu options).
			u2dexGridInspector.DrawSmallGridSizeWarning();
